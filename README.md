...
A console application project written in the PHP programming language and implemented in the Apache NetBeans integrated environment. 
The PHP interpreter provides simple input/output. Determining the sum of digits in a number entered from the keyboard.
...
Интерпретатор PHP. Простой ввод-вывод. Определение суммы цифр в числе, введённом с клавиатуры.
